...
sec_key = (
    "aibrain"  # Can be anything. Has to match with "key" in your TradingView alert message
)

# Telegram Settings
send_telegram_alerts = True
tg_token = "5675379828:AAHjRijYM1mF1WaIK2egcMg4vXp4yn9pYyY"  # Bot token. Get it from @Botfather
channel = -1001819154166  # Channel ID (ex. -1001487568087)
